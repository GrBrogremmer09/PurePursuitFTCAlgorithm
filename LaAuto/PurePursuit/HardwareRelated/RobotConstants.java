...
public class RobotConstants {
    ...
    public static double
        ...
        /*-- Robot Movement --*/
        maxVelocity = 50, // max target velocity for the path follow
        maxAcceleration = 50, // max target acceleration and deceleration for the path follow
        ...
        minRadiusRange = 10, // min lookahead distance
        maxRadiusRange = 30, // max lookahead distance
